...
Version:                   2.7.1
Release:                   0.1.b3.%{baserelease}%{?dist}
...
Requires:                  %{?scl_prefix_java_common}netty
...
%changelog
* Mon Jul 25 2016 Mat Booth <mat.booth@redhat.com> - 2.7.1-0.1.b3.2
- Prevent python bytecode generation
- Fix references to asm5
- Make dep on python unversioned

* Mon Jul 25 2016 Mat Booth <mat.booth@redhat.com> - 2.7.1-0.1.b3.1
